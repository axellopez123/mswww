  ...
  return (
    ...
    >
      <motion.div
        ...
        className="rounded-full border-2 border-white/20 border-double shadow-lg shadow-gray-500 hover:shadow-gray-700 dark:hover:shadow-white backdrop-blur-sm hover:border-white flex items-center justify-center relative px-1 py-1 hover:scale-110 transition duration-150 ease-in-out delay-0"
      >
        {/* <AnimatePresence>
          {hovered && (
            <motion.div
