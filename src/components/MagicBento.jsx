...
const cardData = [
  ...
  {
    type: "form", // 🟢 clave para que sepa mostrar el formulario
    color: "#060010",
    title: "Automation",
...
const MagicBento = ({
  ...
  // Obtener la tarjeta del formulario
  const formCard = cardData.find((card) => card.type === "form");
...
/>
      ...
      <div className="flex flex-col">
        ...
        <textarea
          ...
          className="px-3 py-2 rounded bg-white/10 placeholder-white text-white resize-none focus:outline-none focus:ring-2 focus:ring-purple-500 w-full"
        />
      </div>
      ...
      <button
        type="submit"
        className="mt-2 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 rounded transition w-full"
      >
        Enviar
      </button>
    </form>
  ...
  return (
    <>
          ...
          {cardData.map((card, index) => {
            ...
            if (enableStars) {
              return (
                ...
                >
                  {isFormCard ? (
                    <div className="w-full px-4 max-h-[90vh] overflow-y-auto sm:max-h-[400px] sm:overflow-y-auto">
                      <Formulario />
                    </div>
                  ) : (
                    <>
            ...
            return (
              <div key={index} {...cardProps}>
                {/* Aquí el contenido de las cards sin animación, igual que antes */}
              </div>
            );
          })}
        </BentoCardGrid>
      ...
      {/* Formulario duplicado para móviles, fuera del grid */}
      {isMobile && formCard && (
